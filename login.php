...
echo '<script src="./src/scripts/login.js" type="module"></script>';
...
if (isset($_POST["btnLogin"])) {
  ...
  if (($filasA == 0)) {
    echo '<script type="module">
      ...
      Toast({ text: "El usuario no existe" });
    </script>';
  } else {
    ...
    if (($Contraseña == $password)) {
      ...
      echo '<script type="module">
        import { Toast } from "./src/components/Toast.js";
        Toast({ text: "Las credenciales son incorrectas" });
      </script>';
    }
  }
}
...
<body>
  ...
  <main class="main-container">
    <img src="./src/assets/images/uas-background-overlay.jpg" alt="UAS Backgroud Overlay" class="background-login-image" />

    <div class="background-login-overlay"></div>

    <section class="login-container">
      <form class="form-login-container" action="login" method="POST">
        <span class="bi-people-fill" style="font-size: 4rem; color: #374a57"></span>
