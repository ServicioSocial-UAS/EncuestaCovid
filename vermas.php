    ...
    <header>
        ...
        <div class="login-logout-container">
            <ul class="menu">
                    ...
                    <li><aclass="login-logout" name="logout" onclick="logout()">Cerrar sesión</a></li>
            </ul>
        </div>
    </header>
                    ...
                    <div class="fieldset-container" disabled="disabled">
                        <h2 class="subtitle" id="subtitle1">Datos personales</h2>
                            <div class="date-container">
                                ...
                                <input type="text" class="input-style" disabled value="<?php echo (isset($NumCuenta))?$NumCuenta:'';?>"></div>

                                <div class ="label-style"><label>Nombre: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Nombre))?$Nombre:'';?>"></div>

                                <div class ="label-style"><label>Apellido paterno: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Ape_Pat))?$Ape_Pat:'';?>"></div>
                            
                                <div class ="label-style"><label>Apellido materno: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Ape_Mat))?$Ape_Mat:'';?>"></div>

                                <div class ="label-style"><label>Sexo: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Sexo))?$Sexo:'';?>"></div>
                              
                                <div class ="label-style"><label>Edad: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Edad))?$Edad:'';?>"></div>
    
                                <div class ="label-style"><label>Tipo: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Tipo))?$Tipo:'';?>"></div>

                                <div class ="label-style"><label>Un. académica:</label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Uni_Academica))?$Uni_Academica:'';?>"></div>
                                
                                <div class ="label-style"><label>Carrera: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Carrera))?$Carrera:'';?>"></div>

                                <div class ="label-style"><label>Grupo: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Grupo))?$Grupo:'';?>"></div>
                    ...
                    <div class="fieldset-container">
                        ...
                        <h2 class="subtitle">Contacto</h2>
                            ...
                            <div class="contact-container">
                                ...
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Correo))?$Correo:'';?>"></div>
                                
                                <div class="label-style"><label>Teléfono celular: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Tel1))?$Tel1:'';?>"></div>
                                
                                <div class="label-style"><label>Teléfono Casa:</label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Tel2))?$Tel2:'';?>"></div>

                                <hr class="divider">
                                
                                <div class="label-style"><label >Colonia: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Colonia))?$Colonia:'';?>"></div>

                                <div class="label-style"><label>Calle: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Calle))?$Calle:'';?>"></div>

                                <div class="label-style"><label>Número: </label>
                                <input type="text" class="input-style" disabled value="<?php echo (isset($Numero))?$Numero:'';?>"></div>        
